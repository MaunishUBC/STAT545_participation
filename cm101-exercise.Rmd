...
Curly braces are useful to write multiple lines of code but return a single output. So, R will return the very last line of the sentence
```{r}
square <- function(x)  {
  y <- x^2
  return(y)
...
square(2)
```
Return function is useful if we want to stop early
...
test_that("Simple cases work", {
    ...
    expect_gt(max_minus_min(runif(100)), 1)
...
A lot of R functions have `na.rm` option.
